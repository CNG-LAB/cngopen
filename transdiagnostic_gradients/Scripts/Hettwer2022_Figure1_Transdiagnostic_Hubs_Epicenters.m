...
%% plot HCP connectivity matrices and hubs(*Figure 1B*)
...
figure; plot_cortical(parcel_to_surface(fc_ctx_dc_thresh),'color_range',[0 25],'label_text','normative functional hubs')
figure; plot_cortical(parcel_to_surface(sc_ctx_dc_thresh),'color_range',[0 25],'label_text','normative structural hubs')

%% Co-alteration Hubs (*Figure 1C*)
...
% functional hubs
[r_fchubs,p1] = corr(dis_dc',fc_ctx_dc_thresh');
[p_fchubs, r1_dist] = spin_test(dis_dc',fc_ctx_dc_thresh', 'surface_name', 'fsa5', 'parcellation_name', ...
                                    'aparc', 'n_rot', 1000, 'type', 'pearson');
% structural hubs
[r_schubs,p2] = corr(dis_dc',sc_ctx_dc_thresh');
[p_fchubs, r2_dist] = spin_test(dis_dc',sc_ctx_dc_thresh', 'surface_name', 'fsa5', 'parcellation_name', ...
                                    'aparc', 'n_rot', 1000, 'type', 'pearson');
