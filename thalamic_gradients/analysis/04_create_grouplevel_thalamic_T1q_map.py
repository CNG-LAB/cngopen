...
#save as txt
np.savetxt("/data/p_02666/Project1_thalamus/structural_covariance/grouplevel_T1q_values_lh.txt",T1q, delimiter=' ')
...
thala_ref_lh=nb.load("/data/p_02666/mica-mics/thalamus_space_mni/space-MNI125_atlas-thalamus_lh_refined.nii.gz")
clipped_img = nb.Nifti1Image(image_tmp, thala_ref_lh.affine, thala_ref_lh.header)
    
nb.save(clipped_img, '/data/p_02666/Project1_thalamus/structural_covariance/grouplevel_T1q_map_lh.nii.gz')



# also save some subject data for plotting (figure2)
#sub0
T1q_sub=T1q_stack[:,:,:,0]
thala_ref_lh=nb.load("/data/p_02666/mica-mics/thalamus_space_mni/space-MNI125_atlas-thalamus_lh_refined.nii.gz").get_fdata()
idx_l=np.where(thala_ref_lh==1)
...
thala_ref_lh=nb.load("/data/p_02666/mica-mics/thalamus_space_mni/space-MNI125_atlas-thalamus_lh_refined.nii.gz")
clipped_img = nb.Nifti1Image(image_tmp, thala_ref_lh.affine, thala_ref_lh.header)
nb.save(clipped_img, '/data/p_02666/Project1_thalamus/structural_covariance/T1q_map_lh_sub01.nii.gz')
...
#save as txt
np.savetxt("/data/p_02666/Project1_thalamus/structural_covariance/grouplevel_T1q_values_rh.txt",T1q, delimiter=' ')
...
# save as nifti, with same header informations as thalamus mask
thala_ref_rh=nb.load("/data/p_02666/mica-mics/thalamus_space_mni/space-MNI125_atlas-thalamus_rh_refined.nii.gz")
clipped_img = nb.Nifti1Image(image_tmp, thala_ref_rh.affine, thala_ref_rh.header)
    
nb.save(clipped_img, '/data/p_02666/Project1_thalamus/structural_covariance/grouplevel_T1q_map_rh.nii.gz')
