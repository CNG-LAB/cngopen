...
STRUCTURAL CONN
proof ground truth of structural connectivity 
...
#import thomas atlas 
thomas_matrix_l= nb.load("/data/p_02666/Project1_thalamus/Atlas/THOMAS_download_from_zenodo/res_to_2mm/thomas_left_2mm.nii.gz").get_fdata()
thomas_matrix_r= nb.load("/data/p_02666/Project1_thalamus/Atlas/THOMAS_download_from_zenodo/res_to_2mm/thomas_right_2mm.nii.gz").get_fdata()
...
#
sc_l=np.load("/data/p_02666/Project1_thalamus/structural_connectivity/parcels_200/struc_conn_matrix_lh_avg.npy")
sc_r=np.load("/data/p_02666/Project1_thalamus/structural_connectivity/parcels_200/struc_conn_matrix_rh_avg.npy")

#select nucleus
idx_nucleus_l=np.where(label_l==nucleus_label)  
idx_nucleus_r=np.where(label_r==nucleus_label)  

# select voxel sof struc conn matrix belonging to this nucleus and average rows 
nucleus_conn_l=np.mean(sc_l[idx_nucleus_l],0)
nucleus_conn_r=np.mean(sc_r[idx_nucleus_r],0)
np.save("/data/p_02666/Project1_thalamus/structural_connectivity/projections_thomasnuclei/sc_nucleus_{}_l".format(nucleus_label),nucleus_conn_l)
np.save("/data/p_02666/Project1_thalamus/structural_connectivity/projections_thomasnuclei/sc_nucleus_{}_r".format(nucleus_label),nucleus_conn_r)
...
np.save("/data/p_02666/Project1_thalamus/functional_connectivity/projections_thomasnuclei/fc_nucleus_{}_l".format(nucleus_label),nucleus_conn_l)
np.save("/data/p_02666/Project1_thalamus/functional_connectivity/projections_thomasnuclei/fc_nucleus_{}_r".format(nucleus_label),nucleus_conn_r)
...
#import func conn matrix
scov_l=np.load("/data/p_02666/Project1_thalamus/structural_covariance/voxelwise_struc_cov/struc_cov_lh.npy")
scov_r=np.load("/data/p_02666/Project1_thalamus/structural_covariance/voxelwise_struc_cov/struc_cov_rh.npy")
...
np.save("/data/p_02666/Project1_thalamus/structural_covariance/projections_thomasnuclei/scov_l_nucleus_{}".format(nucleus_label),nucleus_conn_l)
np.save("/data/p_02666/Project1_thalamus/structural_covariance/projections_thomasnuclei/scov_r_nucleus_{}".format(nucleus_label),nucleus_conn_r)
