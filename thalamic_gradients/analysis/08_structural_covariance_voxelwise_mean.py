...
change gradient manually in script (still hard coded)
"""
...
np.save("/Project1_thalamus_gradients/data/structural_covariance/voxelwise_struc_cov/struc_cov_meanint_lh.npy",corr_vx)
...
np.save("/Project1_thalamus_gradients/data/structural_covariance/voxelwise_struc_cov/meanint_corr_grad1_colums_lh.npy", R_values)
...
np.save("/Project1_thalamus_gradients/data/structural_covariance/voxelwise_struc_cov/struc_cov_meanint_rh.npy",corr_vx)
...
np.save("/Project1_thalamus_gradients/data/structural_covariance/voxelwise_struc_cov/meanint_corr_grad1_colums_rh.npy", R_values)
